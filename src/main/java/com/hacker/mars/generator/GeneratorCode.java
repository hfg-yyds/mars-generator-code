package com.hacker.mars.generator;
...
public class GeneratorCode {
    public static String projectPath = "E:\\github\\Mars\\Lottery";
    ...
    private static void extracted1() {
        ...
        PackageConfig packages = new PackageConfig.Builder()
                .entity("po")//实体类包名
                .parent("com.hacker.mars.lottery.infrastructure")//父包名。如果为空，将下面子包名必须写全部， 否则就只需写子包名
...
//                .injection(injectionConfig)
    ...
    private static AutoGenerator getAutoGenerator() {
        ...
        DataSourceConfig dsc = new DataSourceConfig.Builder("jdbc:mysql://localhost:3306/mars?serverTimezone=GMT%2B8",
                "root", "123456")
...
//                .fileOverride()//覆盖生成文件
        ...
        PackageConfig packages = new PackageConfig.Builder()
                ...
                .serviceImpl("service.impl")//service实现类包名
                .other("output")//输出自定义文件时的包名
                .pathInfo(Collections.singletonMap(OutputFile.mapperXml, projectPath + "/src/main/resources/editMapper")) //路径配置信息,就是配置各个文件模板的路径信息,这里以mapper.xml为例
                .build();
        /**
         * 模板配置
         */
